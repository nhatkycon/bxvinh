        ...
        <div class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2 col-xs-4">
                    <input type="text" name="STTBX" disabled id="STTBX" value="<%=Item.STTBX %>" class="form-control STTBX">
                </div>
                <label for="STTALL" class="col-sm-2 col-xs-2 control-label">Số phơi công ty:</label>
                <div class="col-sm-2 col-xs-4">
                    <input type="text" name="STTALL" disabled id="STTALL" value="<%=Item.STTALL %>" class="form-control STTALL">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    ...
                    {%>
                        <input class="XeThayThe input-sm" id="XeThayThe" name="XeThayThe" type="checkbox"/>
                    <% } %>
                </div>    
